...
if __name__ == '__main__':
    ...
    network = nn.DataParallel(models.CNN(args.latent_dim,model_type=args.model_type,num_class=num_class,non_layers=args.non_layers,stripes=args.stripes,temporal=args.temporal))
...
#    print('CMC:', cmc, 'mAP:', map)
    ...
    critetion_id  = nn.CrossEntropyLoss()
    # 2. Optimizer
